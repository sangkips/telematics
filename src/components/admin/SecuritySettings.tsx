              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="p-2 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200 w-full max-w-md">
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-600 text-white rounded-lg transition-colors"
              >
                Generate Key
              </button>
            </div>
